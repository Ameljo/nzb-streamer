 ...
 * @author alex
 */
public class VirtualResource implements Resource, DigestResource {

    private static Logger log = LogManager.getLogger(VirtualResource.class);
    protected UUID id;
    ...
    public VirtualResource(VirtualFolderResource parent, String name) {
        id = UUID.randomUUID();
        this.parent = parent;
        this.name = name;
        modDate = new Date();
