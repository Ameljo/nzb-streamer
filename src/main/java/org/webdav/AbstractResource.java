...
public abstract class AbstractResource extends VirtualResource implements GetableResource, PropFindableResource, DeletableResource, MoveableResource,
    ...
    public void moveTo(CollectionResource rDest, String name) {
        log.debug("moving..");
        VirtualFolderResource d = (VirtualFolderResource) rDest;
    ...
    public void copyTo(CollectionResource toCollection, String destName) {
        ...
        AbstractResource rClone;
        rClone = (AbstractResource) this.clone((VirtualFolderResource) toCollection, destName);
